...
/// Number of opcodes in the VM. Must match the number of variants in Op.
pub const NUM_OPCODES: usize = 56;
...
pub enum Op {
    ...
    GetPropStr { dst: Reg, obj: Reg, name: NameId } = 13,   // fast path — known key
...
impl Op {
    /// Returns the numeric discriminant of this opcode variant.
    /// Safe: implemented as a match — no unsafe pointer casting required.
    #[inline]
